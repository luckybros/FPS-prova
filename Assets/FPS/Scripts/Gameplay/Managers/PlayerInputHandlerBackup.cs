...
{
    public class PlayerInputHandlerBackup : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            m_LookAction = m_PlayerInput.actions.FindAction("Player/Look");
            m_JumpAction = m_PlayerInput.actions.FindAction("Player/Jump");
            m_FireAction = m_PlayerInput.actions.FindAction("Player/Fire");
            m_AimAction = m_PlayerInput.actions.FindAction("Player/Aim");
            m_SprintAction = m_PlayerInput.actions.FindAction("Player/Sprint");
            m_CrouchAction = m_PlayerInput.actions.FindAction("Player/Crouch");
            m_ReloadAction = m_PlayerInput.actions.FindAction("Player/Reload");
            m_NextWeaponAction = m_PlayerInput.actions.FindAction("Player/NextWeapon");
